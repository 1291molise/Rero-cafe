    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-50 text-[#a16207] text-xs font-bold uppercase tracking-wider mb-2 border border-amber-200">
          ...
          <div className="lg:col-span-6 flex flex-col gap-4">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xs border border-[#ded3c5] h-48 sm:h-52 group">
              <img
                ...
                alt="The Valley Guest House scenic grounds and lodge"
              ...
              <div className="absolute bottom-3 left-4 right-4 flex items-center justify-between text-white">
                <div>
                  ...
                  <span className="block text-sm font-serif font-bold text-white">
                    The Valley Guest House · R350 / Couple
                  </span>
                </div>
            ...
            <div className="bg-white rounded-3xl p-5 border border-[#ded3c5] shadow-sm flex-1 flex flex-col justify-between">
              ...
              <div className="relative w-full h-[240px] sm:h-[260px] rounded-2xl overflow-hidden bg-[#e9e4db] border border-[#d6c7b5]">
                ...
                <svg className="absolute inset-0 w-full h-full text-[#d6c8b7]" preserveAspectRatio="none">
                  ...
                  {/* Road highlight for The Valley */}
                  <line x1="15%" y1="5%" x2="75%" y2="95%" stroke="#a16207" strokeWidth="6" strokeDasharray="8 4" />
                </svg>

                {/* Road Labels */}
                <div className="absolute top-[28%] left-[25%] bg-[#faf8f5]/90 backdrop-blur-xs px-2.5 py-1 rounded text-[10px] font-bold text-[#a16207] border border-[#d6c8b7] shadow-xs rotate-12">
                  The Valley Scenic Route
                </div>
                ...
                {/* Pinpoint for The Valley Guest House */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group cursor-pointer">
                  {/* Radar ripple */}
                  <span className="absolute w-12 h-12 rounded-full bg-[#a16207]/30 animate-ping pointer-events-none" />
                  ...
                  <div className="relative z-10 bg-[#111111] text-white px-3.5 py-2 rounded-2xl shadow-xl border-2 border-white flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="block text-[10px] text-amber-300 leading-none mt-0.5">
                        R350 / Night For A Couple
                      </span>
                    </div>
                  </div>
